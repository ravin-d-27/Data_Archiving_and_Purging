...
-- Final Working procedure for Updating the data even though columns are extra or less in source table using Dynamic SQL
...
EXEC Find_Extra_Columns_8 
    'TestDB_Backup.dbo.ChildTable1', 
    'TestDB.dbo.ChildTable1', 
    @ColumnList = @result OUTPUT;
...
EXEC Find_Extra_Columns_Modified_2
    'TestDB_Backup.dbo.ChildTable1', 
    'TestDB.dbo.ChildTable1', 
    @ColumnList = @result OUTPUT;
